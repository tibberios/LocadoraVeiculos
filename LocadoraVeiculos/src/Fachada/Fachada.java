...
public class Fachada {
	...
	public void inserirPessoa (String nome, String cpf, String senha, String telefone, String tipo_inserir) {
		...
		if (tipo_inserir.equals("funcionario")) {
			...
			if (inserido == true) {
				this.funcionario.inserirFuncionario(nome, cpf, senha, telefone);
			}
		}
	}
}
