	...
	public AtualizarFuncionario() {
		...
		btnSalvar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					Fachada.getInstance().inserirPessoa((String)inputNome.getText(), (String)inputCpf.getText(), (String)inputSenha.getText(),(String) inputTelefone.getText() ,(String)inputEmail.getText(), "atualizar");
					preencherCMB();
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Funcionario f = Fachada.getInstance().findFuncionarioByName((String) comboBox.getSelectedItem()).get(0);
